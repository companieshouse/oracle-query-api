...
public enum TransactionCategory {
    ...
    ACCOUNTS("0", "Accounts"), ANNUAL_RETURN("1", "Annual Return"), APPOINTMENT("2", "Appointment"),
    REGISTERED_OFFICE("3", "Registered Office"), MORTGAGE("4", "Mortgage"), LIQUIDATION("5", "Liquidation"),
    INCORPORATION("6", "New Incorporation"), CHANGE_OF_NAME("7", "Change Of Name"), CAPITAL("8", "Capital"),
