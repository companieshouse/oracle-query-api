...
public interface OverseasEntityBeneficialOwnerRepository extends PagingAndSortingRepository<OverseasEntityBeneficialOwner, Long> {
    ...
    @Query(value = "select "
            ...
            + "AD.STREET as PRINCIPAL_ADDRESS_LINE_1, "
            + "AD.AREA as PRINCIPAL_ADDRESS_LINE_2, "
            + "AD.CARE_OF as PRINCIPAL_ADDRESS_CARE_OF, "
            + "AD.COUNTRY_NAME as PRINCIPAL_ADDRESS_COUNTRY_NAME, "
            + "AD.POST_TOWN as PRINCIPAL_ADDRESS_POST_TOWN, "
            + "AD.PO_BOX as PRINCIPAL_ADDRESS_PO_BOX, "
            + "AD.POST_CODE as PRINCIPAL_ADDRESS_POST_CODE, "
            + "AD.HOUSE_NAME_NUMBER as PRINCIPAL_ADDRESS_HOUSE_NAME_NUMBER, "
            + "AD.REGION as PRINCIPAL_ADDRESS_REGION, "
