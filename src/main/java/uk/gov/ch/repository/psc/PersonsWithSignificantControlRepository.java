...
public interface PersonsWithSignificantControlRepository extends PagingAndSortingRepository<PersonWithSignificantControl, Long> {
    ...
    @Query(value = "select "
            ...
            + "group by CBA.CORPORATE_BODY_APPOINTMENT_ID, CBA.OFFICER_FORENAME_1, CBA.OFFICER_FORENAME_2, CBA.OFFICER_SURNAME, CBA.APPOINTMENT_TYPE_ID, ADR.HOUSE_NAME_NUMBER, ADR.STREET, ADR.POST_CODE, ADR.POST_TOWN, "
