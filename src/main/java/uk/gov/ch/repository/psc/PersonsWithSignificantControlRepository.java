...
public interface PersonsWithSignificantControlRepository extends PagingAndSortingRepository<PersonWithSignificantControl, Long> {
    ...
    @Query(value = "select " +
            ...
            "CBA.SERVICE_ADDRESS_POST_CODE, CBA.SERVICE_ADDRESS_POST_TOWN, ADR.CARE_OF, ADR.REGION, ADR.COUNTRY_NAME, ADR.PO_BOX, ADR.AREA, ADR.HOUSE_NAME_NUMBER, OD.OFFICER_NATIONALITY, OD.OFFICER_DATE_OF_BIRTH, " +
