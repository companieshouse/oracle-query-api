 ...
 */
@Repository
public interface ScottishBankruptOfficersRepository extends
        PagingAndSortingRepository<ScottishBankruptOfficerDataModel, String>,
        CrudRepository<ScottishBankruptOfficerDataModel, String> {
     ...
     * <p>
     * Spring data will automatically create the implementation of this interface when the service
     * is running. The pagination and sorting will be automatically handled by
    ...
    @Query(value = "select * "
            ...
            + "or (DATE_OF_BIRTH = TO_DATE(:fromDob, 'YYYY-MM-DD')) "
            + "or (DATE_OF_BIRTH = TO_DATE(:toDob, 'YYYY-MM-DD'))"
            ...
            countQuery = "select COUNT(*) "
                    ...
                    + "and (:postcode is null or upper(replace(ADDRESS_POSTCODE, ' ', '')) = upper(replace(:postcode, ' ', ''))) ",
            nativeQuery = true)
    Page<ScottishBankruptOfficerDataModel> findScottishBankruptOfficers(
            @Param("forename") String forename, @Param("surname") String surname,
            @Param("alias") String alias, @Param("fromDob") String fromDateOfBirth,
            @Param("toDob") String toDateOfBirth, @Param("postcode") String postcode,
            Pageable pageable);
}
