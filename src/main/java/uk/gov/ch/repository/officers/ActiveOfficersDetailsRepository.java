...
public interface ActiveOfficersDetailsRepository extends PagingAndSortingRepository<ActiveOfficerDetails, Long> {
    ...
    @Query(value = "select * from ( SELECT "
            ...
            + "apt.appointment_type_desc as appointment_type, "
            + "case when ofc.CORPORATE_OFFICER_IND='Y' then 1 else 0 end corporate_officer, "
            ...
            + "FROM corporate_body cb, corporate_body_appointment cba, officer_detail od, address adr, usual_residential_address ura, officer ofc, appointment_type apt "
