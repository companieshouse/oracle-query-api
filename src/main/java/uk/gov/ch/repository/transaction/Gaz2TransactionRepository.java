...
public interface Gaz2TransactionRepository extends
        PagingAndSortingRepository<Gaz2TransactionDataModel, Long> {

    @Query(value =
            "select tr.TRANSACTION_ID, tr.TRANSACTION_TYPE_ID, tr.TRANSACTION_STATUS_TYPE_ID " +
