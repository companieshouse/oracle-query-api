...
public class CorporateTrusteesServiceImpl implements CorporateTrusteesService {
    ...
    public CorporateTrusteesServiceImpl(CorporateTrusteesRepository corporateTrusteesRepository) {
        this.corporateTrusteesRepository = corporateTrusteesRepository;
    }
