...
public class PersonsWithSignificantControlController {
    ...
    public ResponseEntity<List<PersonWithSignificantControl>> getPeopleWithSignificantControl(@PathVariable String companyNumber,
        ...
        List<PersonWithSignificantControl> result = personsWithSignificantControlService.getPersonsWithSignificantControl(companyNumber, pageable);
