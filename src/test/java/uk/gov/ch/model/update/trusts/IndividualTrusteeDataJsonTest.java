...
class IndividualTrusteeDataJsonTest extends AbstractJsonTest {
    ...
    void serializesToExpectedJsonStructure() {
        ...
        try {
            ...
            assertThat(node.get("trusteeForename1").asString()).isEqualTo(TRUSTEE_FORENAME1);
            assertThat(node.get("trusteeForename2").asString()).isEqualTo(TRUSTEE_FORENAME2);
            assertThat(node.get("trusteeSurname").asString()).isEqualTo(TRUSTEE_SURNAME);
    ...
    private void assertResidentialAddress(JsonNode usualResidentialAddress) {
           assertThat(usualResidentialAddress.get("address_line_1").asString()).isEqualTo(RESIDENTIAL_ADDRESS_STREET);
           assertThat(usualResidentialAddress.get("address_line_2").asString()).isEqualTo(RESIDENTIAL_ADDRESS_AREA);
           assertThat(usualResidentialAddress.get("care_of").isNull()).isTrue();
           assertThat(usualResidentialAddress.get("country").asString()).isEqualTo(RESIDENTIAL_ADDRESS_COUNTRY);
           assertThat(usualResidentialAddress.get("locality").asString()).isEqualTo(RESIDENTIAL_ADDRESS_TOWN);
           assertThat(usualResidentialAddress.get("po_box").isNull()).isTrue();
           assertThat(usualResidentialAddress.get("postal_code").asString()).isEqualTo(RESIDENTIAL_ADDRESS_POSTCODE);
           assertThat(usualResidentialAddress.get("region").asString()).isEqualTo(RESIDENTIAL_ADDRESS_REGION);
   }
