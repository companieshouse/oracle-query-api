...
class ScottishBankruptOfficerDetailsJsonTest extends AbstractJsonTest {
    ...
    private static final String COUNTRY = "address county";
    ...
    void serializesToExpectedJsonStructure() {
        ...
        try {
            ...
            assertThat(node.get("county").asString()).isEqualTo(COUNTRY);
